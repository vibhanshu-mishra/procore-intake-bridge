...
help:
	...
	@echo "  make versioned-release-handoff Review the offline 0.1.0 handoff"
	@echo "  make release-notes-draft Print the draft notes; releases nothing"
...
versioned-release-handoff:
	$(PYTHON) scripts/run_versioned_release_handoff.py
release-scope-summary:
	$(PYTHON) scripts/print_release_scope_summary.py
maintainer-release-decision-checklist:
	$(PYTHON) scripts/print_maintainer_release_decision_checklist.py
