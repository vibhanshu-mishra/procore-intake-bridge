...
The packet references private sandbox smoke evidence; it never embeds report contents. The smoke
probe is read-only evidence for human review, not approval by itself.
