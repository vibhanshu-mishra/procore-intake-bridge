...
I8 includes I6 in the [Final Security Readiness Review](final-security-readiness-review.md), still
without a live scanner, external registry/GitHub call, package build, release, or deployment. The
public result is maintainer-review input only; private release-process and provenance review
remain required, and no production, pilot, legal, compliance, or certification approval follows.
